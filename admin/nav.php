...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="https://www.facebook.com/lumanhgioi.vn" class="nav-link">LIÊN HỆ KỸ THUẬT</a>
        </li>
    </ul>
    <!-- Right navbar links -->
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="uytin.php" class="nav-link">
                                <p><i class="nav-icon fa fa-envelope-open"></i> THÊM HỒ SƠ UY TÍN </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="chuyen-muc.php" class="nav-link">
                                <p><i class="nav-icon fa fa-envelope-open" aria-hidden="true"></i> THÊM DỊCH VỤ</p>
                            </a>
                        </li>
                        <li class="nav-item">
